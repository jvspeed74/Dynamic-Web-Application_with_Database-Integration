            ...
            <table cellspacing="0" cellpadding="3" style="border: 1px solid silver; padding:5px; margin-bottom: 10px">
                <?php foreach ($rows as $row) { ?>
                    <tr>
                        ...
                        <td><input name="title" value="<?php echo $row['title'] ?>" type="text" maxlength="50" size="50"
                                   required/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="genre">
                                <option <?= $row['genre'] == 'Action-Adventure' ? 'selected' : ''; ?>>Action-Adventure
                                </option>
                                <option <?= $row['genre'] == 'Action-Role Playing' ? 'selected' : ''; ?>>Action-Role
                                    Playing
                                </option>
                                <option <?= $row['genre'] == 'First-Person Shooter' ? 'selected' : ''; ?>>First-Person
                                    Shooter
                                </option>
                                <option <?= $row['genre'] == 'Life Simulation' ? 'selected' : ''; ?>>Life Simulation
                                </option>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="developer">
                                <option <?= $row['developer'] == '343 Industries' ? 'selected' : ''; ?>>343 Industries
                                </option>
                                <option <?= $row['developer'] == 'CD Projekt Red' ? 'selected' : ''; ?>>CD Projekt Red
                                </option>
                                <option <?= $row['developer'] == 'EA Tiburon' ? 'selected' : ''; ?>>EA Tiburon</option>
                                <option <?= $row['developer'] == 'Nintendo EPD' ? 'selected' : ''; ?>>Nintendo EPD
                                </option>
                                <option <?= $row['developer'] == 'Rockstar Studios' ? 'selected' : ''; ?>>Rockstar
                                    Studios
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="publisher">
                                ...
                                <option <?= $row['publisher'] == 'Rockstar Games' ? 'selected' : ''; ?>>Rockstar Games
                                </option>
                                <option <?= $row['publisher'] == 'Xbox Game Studios' ? 'selected' : ''; ?>>Xbox Game
                                    Studios
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input name="rating" value="<?php echo $row['rating'] ?>" step="0.1" min="0.0" max="10.0"
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="esrb">
                                ...
                                <option <?= $row['esrb'] == 'Rating Pending' ? 'selected' : ''; ?>>Rating Pending
                                </option>
                    ...
                    <tr>
                        ...
                        <td><input name="image" value="<?php echo $row['image'] ?>" type="text" maxlength="100"
                    ...
                    <tr>
                        ...
                        <td><input name="price" value="<?php echo $row['price'] ?>" type="number" step="0.01" required/>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align: right; vertical-align: top">Description:</td>
                        <td><textarea name="description" maxlength="5000" rows="6"
                                      cols="65"><?php echo $row['description'] ?></textarea></td>
                    </tr>
                <?php } ?>
            </table>
